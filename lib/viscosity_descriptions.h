...
struct VISC_OPT {
    ...
    float z410;
    float zlith;
  double zbase_layer[CITCOM_MAX_VISC_LAYER]; /* new */
  int nbase_layer[CITCOM_MAX_VISC_LAYER]; /* new */
    ...
    float sdepv_bg[CITCOM_MAX_VISC_LAYER];
    float alpha,beta;
